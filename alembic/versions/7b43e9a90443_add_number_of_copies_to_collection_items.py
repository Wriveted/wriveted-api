...
def upgrade():
    ...
    op.add_column('collection_items', sa.Column('copies_available', sa.Integer(), nullable=True))
    op.add_column('collection_items', sa.Column('copies_on_loan', sa.Integer(), nullable=True))
