...
def upgrade():
    ...
    sa.Column('reading_ability', sa.Enum('SPOT', 'CAT_HAT', 'TREEHOUSE', 'CHARLIE_CHOCOLATE', 'HARRY_POTTER', name='readingability'), nullable=True),
    sa.Column('doe_code', sa.Enum('DOE_2G', 'DOE_2H', 'DOE_2I', 'DOE_2J', 'DOE_2K', 'DOE_2L', 'DOE_3G', 'DOE_3H', 'DOE_3I', 'DOE_3J', 'DOE_3K', 'DOE_3L', 'DOE_4G', 'DOE_4H', 'DOE_4I', 'DOE_4J', 'DOE_4K', 'DOE_4L', name='doecode'), nullable=True),
    ...
    sa.ForeignKeyConstraint(['labelled_by_id'], ['users.id'], name='fk_labeller_labelset'),
    sa.ForeignKeyConstraint(['work_id'], ['works.id'], name='fk_labelset_work'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('labelset_hue_association',
    ...
    sa.ForeignKeyConstraint(['hue_id'], ['hues.id'], name='fk_labelset_hue_association_hue_id'),
    sa.ForeignKeyConstraint(['labelset_id'], ['labelsets.id'], name='fk_labelset_hue_association_labelset_id'),
