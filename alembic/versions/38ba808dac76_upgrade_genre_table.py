...
def upgrade():
    ...
    genresource = sa.Enum('BISAC', 'BIC', 'THEMA', 'LOCSH', 'HUMAN', 'OTHER', name='genresource')
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('genres', sa.Column('bisac_code', sa.VARCHAR(length=12), autoincrement=False, nullable=True))
