...
def upgrade():
    ...
    op.add_column('editions', sa.Column('hydrated', sa.Boolean(), sa.Computed('hydrated_at is not null', ), nullable=True))
    op.create_index(op.f('ix_editions_hydrated'), 'editions', ['hydrated'], unique=False)
