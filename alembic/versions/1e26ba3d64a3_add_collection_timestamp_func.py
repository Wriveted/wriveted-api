...
def upgrade():
    ...
    # Note: FK was dropped by 95df158f258b, so we just create it fresh with CASCADE options
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    # Note: Just drop the FK - 95df158f258b downgrade will recreate it without CASCADE
    op.drop_constraint(
