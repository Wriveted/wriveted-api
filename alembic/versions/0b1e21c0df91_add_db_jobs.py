...
def upgrade():
    ...
    sa.Column('job_type', sa.Enum('POPULATE', 'UPDATE', name='jobtype'), nullable=False),
    sa.Column('job_status', sa.Enum('PENDING', 'RUNNING', 'COMPLETE', name='jobstatus'), nullable=False),
