...
def upgrade():
    ...
    op.add_column('readers', sa.Column('first_name', sa.String(), server_default='', nullable=False))
    op.add_column('readers', sa.Column('last_name_initial', sa.String(), server_default='', nullable=False))
