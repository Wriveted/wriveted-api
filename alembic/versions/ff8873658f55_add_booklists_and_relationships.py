...
def upgrade():
    ...
    sa.Column('type', sa.Enum('WISH_LIST', 'HAS_READ', 'SCHOOL', 'REGION_LIST', 'HUEY_LIST', 'OTHER_LIST', name='listtype'), nullable=False),
    sa.Column('info', sa.JSON(), nullable=True),
    sa.Column('school_id', sa.Integer(), nullable=True),
    sa.Column('user_id', postgresql.UUID(as_uuid=True), nullable=True),
    sa.Column('service_account_id', postgresql.UUID(as_uuid=True), nullable=True),
    sa.ForeignKeyConstraint(['school_id'], ['schools.id'], name='fk_booklist_school'),
    sa.ForeignKeyConstraint(['service_account_id'], ['service_accounts.id'], name='fk_booklist_service_account'),
    ...
    op.create_table('booklist_work_association',
    sa.Column('work_id', sa.Integer(), nullable=False),
    sa.Column('booklist_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['booklist_id'], ['book_lists.id'], name='fk_booklist_works_association_booklist_id'),
    sa.ForeignKeyConstraint(['work_id'], ['works.id'], name='fk_booklist_works_association_work_id'),
