"""Add original schools/works/editions tables

Revision ID: a7f1942d3ae5
Revises: 9e2c2d162ac7
Create Date: 2021-12-27 10:44:38.389252
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['author_id'], ['authors.id'], name='fk_author_works_association_author_id'),
    sa.ForeignKeyConstraint(['work_id'], ['works.id'], name='fk_author_works_association_work_id'),
    ...
    sa.Column('state', sa.Enum('ACTIVE', 'INACTIVE', name='schoolstate'), nullable=False),
    ...
    sa.Column('info', sa.JSON(), nullable=True),
    sa.ForeignKeyConstraint(['country_code'], ['countries.id'], name='fk_school_country'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index('index_schools_by_country', 'schools', ['country_code', 'official_identifier'], unique=True)
    op.create_index(op.f('ix_schools_country_code'), 'schools', ['country_code'], unique=False)
    op.create_table('series_works_association',
    sa.Column('series_id', sa.Integer(), nullable=False),
    sa.Column('work_id', sa.Integer(), nullable=False),
    sa.Column('order_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['series_id'], ['series.id'], name='fk_illustrator_editions_assoc_illustrator_id'),
    sa.ForeignKeyConstraint(['work_id'], ['works.id'], name='fk_series_works_assoc_work_id'),
    ...
    sa.Column('info', sa.JSON(), nullable=True),
    sa.ForeignKeyConstraint(['edition_id'], ['editions.id'], name='fk_collection_items_edition_id'),
    sa.ForeignKeyConstraint(['school_id'], ['schools.id'], name='fk_collection_items_school_id'),
    sa.ForeignKeyConstraint(['work_id'], ['works.id'], name='fk_collection_items_work_id'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_collection_items_school_id'), 'collection_items', ['school_id'], unique=False)
    op.create_index(op.f('ix_collection_items_work_id'), 'collection_items', ['work_id'], unique=False)
    ...
    sa.ForeignKeyConstraint(['edition_id'], ['editions.id'], name='fk_illustrator_editions_assoc_edition_id'),
    sa.ForeignKeyConstraint(['illustrator_id'], ['illustrators.id'], name='fk_illustrator_editions_assoc_illustrator_id'),
