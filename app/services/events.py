...
from app.models.user import UserAccountType, User
from app.schemas.booklist import BookListUpdateIn, BookListItemUpdateIn, ItemUpdateType, BookListItemInfo, \
    BookListCreateIn
...
def process_book_review_event(session: Session, event: Event):
    ...
    if event.school is None:
        ...
        booklist = update_or_create_liked_books(session,
                                                liked_items,
