...
from app.api.dependencies.security import get_current_active_superuser, \
    get_current_active_superuser_or_backend_service_account, get_current_active_user_or_service_account
...
async def get_service_accounts(
        ...
        current_account: Union[User, ServiceAccount] = Depends(get_current_active_user_or_service_account),
